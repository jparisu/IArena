...
class PruneMinimaxPlayer(IPlayer):
    """
    ...
    def play(
        ...
        return self.minimax(position, self.min_alpha, self.max_beta)[1]


    @override
    def minimax(self, position: IPosition, alpha: MinimaxScoreType, beta: MinimaxScoreType) -> Tuple[MinimaxScoreType, IMovement]:
