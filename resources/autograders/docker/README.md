...
sudo docker run --rm -v "$(pwd)/resources/autograders/docker/shared:/data" iarena-grader:multigrader --zip-file /data/IA_2526_p2_01.zip --configuration-file https://raw.githubusercontent.com/jparisu/IArena/refs/heads/main/resources/graders/IA_MAT_2526_mastermind_rep.yaml --result-file /data/result.csv --repetitions 10 --debug > output.tmp
